...
class VisualCNN(nn.Module):
    r"""Modified 3-Conv CNN that outputs a sequence of visual patch features [B, N, D]

    Args:
        observation_space: The observation_space of the agent
        output_size: The size of the embedding vector per patch
    """
    ...
    def __init__(self, observation_space, output_size, extra_rgb):
        ...
        if self.is_blind:
            ...
            self.output_height = self.output_width = 0
        else:
